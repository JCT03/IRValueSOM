...
//    private int maxDepth;
    ...
    private HashMap<Integer, HashMap<Integer, Checkerboard>> gameRecords;
    @Override
    ...
    public AlphaBetaImproved(ToIntFunction<Checkerboard> e){
        super(e);
        gameRecords = new HashMap<Integer, HashMap<Integer, Checkerboard>>();
    }
...
//                gameRecords.put(Integer.MAX_VALUE, )
