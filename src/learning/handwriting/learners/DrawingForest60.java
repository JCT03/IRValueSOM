...
public class DrawingForest60 extends RandomForest<Drawing,String,DrawingPoint, PixelUse> implements PixelUser {
    private int width, height;

    public DrawingForest60() {
        super(60, Drawing::allFeatures, Drawing::getFeatureValue, PixelUse::successor);
    }
